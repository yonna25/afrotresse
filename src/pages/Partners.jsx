...
// On garde tes données ici pour que ça marche immédiatement sans Supabase
const PARTNERS = [
  {
    id: 1,
    name: "Luxe Coiffure",
    ...
    longDescription: "Luxe Coiffure est notre partenaire privilégié pour tout ce qui concerne la santé du cheveu afro. Ils proposent des soins profonds et des conseils personnalisés.",
    specialOffer: "10% de réduction pour les membres AfroTresse"
  }
  // Tu peux copier-coller l'objet ci-dessus pour ajouter d'autres partenaires manuellement
];
        ...
        {selectedPartner && (
          <>
            ...
            <div className="fixed inset-0 z-[1001] flex items-center justify-center p-4 pointer-events-none">
              ...
              >
                <button onClick={() => setSelectedPartner(null)} className="absolute top-6 right-6 w-10 h-10 bg-black/10 rounded-full flex items-center justify-center z-20">✕</button>
                <div className="flex flex-col md:flex-row">
                  ...
                  <div className="md:w-1/2 p-8 md:p-12">
                    ...
                    <button className="w-full py-4 bg-[#2C1A0E] text-white rounded-2xl font-bold text-xs uppercase tracking-widest hover:bg-[#C9963A] transition-colors">Visiter le site</button>
                  </div>
                </div>
              </motion.div>
            </div>
