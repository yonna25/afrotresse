                  ...
                  {req.status === "pending" && (
                    <div className="flex gap-2">
                      <button
                        ...
                        className={`flex-1 py-2.5 rounded-xl text-[10px] font-black border transition-all ${approving === req.id ? "bg-white/5 text-white/20 border-white/10 cursor-not-allowed" : "bg-green-500/15 text-green-400 border-green-500/25 hover:bg-green-500/25"}`}
                      >
                        {approving === req.id ? "⏳ Traitement…" : "✅ Approuver"}
                      </button>
                      <button
