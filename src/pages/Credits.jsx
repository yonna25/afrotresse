      ...
      FedaPay.init({
        ...
        onComplete: (response) => {
          ...
          if (response.reason === FedaPay.CHECKOUT_COMPLETED) {
            ...
            // 3. Sync Supabase en arrière-plan
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-[#C9963A] text-sm font-bold mt-1">{pack.credits} crédits</p>
                  </div>
                ...
                <p className="text-xs opacity-70 leading-relaxed">{pack.description}</p>
                {pack.tagline && (
                  <p className="text-xs font-semibold text-[#C9963A]/80 italic">{pack.tagline}</p>
                )}
              </div>
